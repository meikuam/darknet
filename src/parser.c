...
convolutional_layer parse_convolutional(list *options, size_params params)
{
    ...
    int have_bias = option_find_int_quiet(options, "have_bias", 1);
    if(pad) padding = size/2;
    ...
    convolutional_layer layer = make_convolutional_layer(batch,h,w,c,n,groups,size,stride,padding,activation, batch_normalize, binary, xnor, params.net->adam, have_bias);
